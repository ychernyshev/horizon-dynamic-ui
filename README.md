...
- Все монтується через `PanelManager.mountScene(sceneName)`
...
### 🔧 4. Свій маршрутизатор без залежностей
...
### 5. Ідеальний для Hosting Anywhere
...
```
### 🎨 6. Розроблений для динамічних шаблонів
...
### Для створення чого можна використовувати?
...
│   ├── main.js            ← Ініціалізація Horizon (router, PanelManager)
...
| `core/tce`         | Рушій, що монтує сцени за Registry та PanelManager                 |
...
|-----------------------------|-------------------------------------------|
| Створити головну сторінку   | `PanelManager.mountScene("home")`        |
